...
class Larves
  ...
  def to_json_larves
    ...
    puts "Fichier larves.json reecrit avec success!"
  end
end
...
class Monstres_des_cavernes
  ...
  def to_json_monsters1
    ...
    puts "Fichier Monstres_des_cavernes.json reecrit avec success!"
  end
end
...
class Monstres_des_plaines
  ...
  def to_json_monsters2
    ...
    puts "Fichier Monstres_des_plaines_herbeuses.json reecrit avec success!"
  end
end
